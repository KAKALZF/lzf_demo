...
import com.ample16.backend.shiro.MyShiroRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(DefaultWebSecurityManager securityManager) {
        ...
        //访问的是后端url地址为 /test/loginRemind的接口,提醒用户登录用的
        shiroFilterFactoryBean.setLoginUrl("/test/loginRemind");
        //登录成功后要跳转的链接,登录成功后并不会跳,原因未明,可以由前端控制
...
//        filterChainDefinitionMap.put("/test/testShiro", "anon");
